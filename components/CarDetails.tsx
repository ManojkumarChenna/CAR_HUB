            ...
            <Dialog as="div" onClose={closeModal} className="relative z-10">
                ...
                <div className='fixed inset-0 overflow-y-auto'>
                    ...
                    justify-center p-4 text-center '>
                         <Transition.Child as={Fragment} 
                enter="ease-out duration-300"
                enterFrom='opacity-95' enterTo='opacity-100'
                leave='ease-in duration-200' 
                    ...
                    p-6 text-left shadow-xl transition-all flex flex-col gap-5'>
                        ...
                        <div className='flex-1 flex flex-col gap-3'>
                            ...
                            <div className='flex gap-3'>
                                ...
                                <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                                <Image src={generateCarImageUrl(car,'35')} alt='car model' fill priority className='object-contain'/>
                                </div>
                                <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                                <Image src={generateCarImageUrl(car,'14')} alt='car model' fill priority className='object-contain'/>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className='mt-3 flex flex-wrap gap-4'>
                                {Object.entries(car).map(([key,value])=>(
                                   <div className='flex justify-between gap-5 w-full text-right' key={key}>
                                        ...
                                        <p className='text-black-10 font-semibold'>{value}</p>
                                    </div> 
                                ))}
                            </div>
